...
for index_iter in range(ITER):
    ...
    best_weights_SEN_path = 'F:/transfer code/Tensorflow  Learning/3D-SENet/models-in-19-3-613/Indian_best_3D_SEN_' + str(
        index_iter + 1) + '.hdf5'
    ...
    # 测试
    tic7 = time.clock()
    loss_and_metrics = model_SEN.evaluate(
    ...
    print('3D SEN Test score:', loss_and_metrics[0])
    print('3D SEN Test accuracy:', loss_and_metrics[1])
...
modelStatsRecord.outputStats(KAPPA_3D_SEN, OA_3D_SEN, AA_3D_SEN, ELEMENT_ACC_3D_SEN,
                             ...
                             history_3d_SEN, loss_and_metrics, CATEGORY,
                             'F:/transfer code/Tensorflow  Learning/3D-SENet/records-in-19-3-613/IN_train_3D.txt',
                             'F:/transfer code/Tensorflow  Learning/3D-SENet/records-in-19-3-613/IN_train_3D_element.txt')
