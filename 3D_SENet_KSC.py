...
# 加载数据
mat_data = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-SENet/datasets/ksc/KSC.mat')
data_IN = mat_data['KSC']
# 标签数据
mat_gt = sio.loadmat('F:/transfer code/Tensorflow  Learning/3D-SENet/datasets/ksc/KSC_gt.mat')
gt_IN = mat_gt['KSC_gt']
...
for index_iter in range(ITER):
    ...
    best_weights_SENet_path = 'F:/transfer code/Tensorflow  Learning/3D-SENet/models-ksc-13-514-5/ksc_best_3D_SENet_' + str(
        index_iter + 1) + '.hdf5'
...
modelStatsRecord.outputStats(KAPPA_3D_SENet, OA_3D_SENet, AA_3D_SENet, ELEMENT_ACC_3D_SENet,
                             ...
                             'F:/transfer code/Tensorflow  Learning/3D-SENet/records-ksc-13-514-5/IN_train_3D.txt',
                             'F:/transfer code/Tensorflow  Learning/3D-SENet/records-ksc-13-514-5/IN_train_3D_element.txt')
